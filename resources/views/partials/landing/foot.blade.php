<footer class="bg-white dark:bg-gray-900 border-t border-[#cfdbe7] dark:border-gray-800 px-10 py-12">
    <div class="flex flex-col md:flex-row justify-between gap-10 max-w-[960px] mx-auto">
        ...
        <div class="flex flex-wrap gap-12">
            ...
            <div class="flex flex-col gap-3">
                <h4 class="text-[#0d141b] dark:text-white font-bold text-sm uppercase tracking-wider">Connect
                </h4>
    ...
    <div
        class="max-w-[960px] mx-auto mt-12 pt-8 border-t border-gray-100 dark:border-gray-800 text-center text-sm text-gray-400">
