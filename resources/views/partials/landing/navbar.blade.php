<header
    class="sticky top-0 z-50 flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#e7edf3] bg-white/90 backdrop-blur-md px-10 py-3">
    <a href="{{ route('home') }}" wire:navigate>
        <div class="flex items-center gap-4 text-[#0d141b]">
            ...
            <h2 class="text-[#0d141b] text-xl font-bold leading-tight tracking-[-0.015em]">
                {{ config('app.name') }}
            </h2>
        </div>
    </a>
    <div class="flex flex-1 justify-end gap-8">
        <div class="hidden lg:flex items-center gap-9">
            ...
            <a class="text-[#0d141b] text-sm font-medium leading-normal hover:text-primary transition-colors {{ request()->routeIs('mentorship') ? 'text-primary font-semibold' : '' }}"
                href="{{ route('mentorship') }}" wire:navigate>Mentorship
            </a>
            <a class="text-[#0d141b] text-sm font-medium leading-normal hover:text-primary transition-colors {{ request()->routeIs('about') ? 'text-primary font-semibold' : '' }}"
                href="{{ route('about') }}" wire:navigate>About Us
            </a>
            <a class="text-[#0d141b] text-sm font-medium leading-normal hover:text-primary transition-colors {{ request()->routeIs('contact') ? 'text-primary font-semibold' : '' }}"
